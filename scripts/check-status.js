...
const sitesConfig = [
  {
    id: "projects",
    name: "Netlivy TV",
    description: "Experience the magic with us explore Amediateka,Онлайн ТВ и Кино",
  ...
  },
  {
    id: "docs",
    name: "Netlivy Quiz",
    description: "100+ curated DevOps learning materials",
    url: "https://netlivyquizes.vercel.app",
    icon: "📚",
  },
  {
    id: "repos",
    name: "Netlivy Downliader",
    description: "Collection of scripts, infrastructure code & easy download",
    url: "https://netlivydw.vercel.app",
    icon: "📦",
  },
  {
    id: "jobs",
    name: "Netlivy Praytime",
    description: "Find your prayer time",
    url: "https://netlivypraytime.vercel.app",
    icon: "🧭",
  },
  {
    id: "blog",
    name: "ByteX portfolio",
    description: "Deep dives into  practices & tutorials",
  ...
  },
  {
    id: "cloud",
    name: "Cloud Blog",
    description: "Cloud architecture & implementation guides (soon)",
    url: "",
    icon: "☁️",
  },
  {
    id: "docker2k8s",
    name: "Netlivy News",
    description: "See the news you're interested in live.",
